var barGroup = "all",
    currColor = '#20558a'; //currColor = 'rgb(51, 74, 115)';
...
function setTypeParams(plotType) {
    if (plotType === 'browser') {
        return {
            div: '#browserChart',
            svg: 'browserBarChartPlot',
            type: 'browser',
            views: browserTotalViews,
            visits: browserTotalVisits,
            height: 300
        };
    } else if (plotType === 'device') {
        return {
            div: '#deviceChart',
            svg: 'deviceBarChartPlot',
            type: 'device',
            views: deviceTotalViews,
            visits: deviceTotalVisits,
            height: 300
        };
    } else {
        return {
